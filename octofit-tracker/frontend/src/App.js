    ...
    <Router>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="card p-4 text-center"><h2 className="display-5 mb-3">Welcome to <span className="text-primary">Octofit Tracker</span>!</h2><p className="lead">Track your fitness, join teams, and compete on the leaderboard.</p></div>} />
        </Routes>
      </div>
    </Router>
  );
